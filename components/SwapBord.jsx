...
function SwapBord({coin,refetch,  setCoin, index , changeAmount,switchTokens,modifyToken, tokenAmount, disabled}) {
  ...
  return (
    <div className='relative '>
        <CoinModal index={index} refetch={refetch} isOpen={isOpen} coin={coin} setCoin={setCoin} closeModal={closeModal} modifyToken={modifyToken}  />
        {/* <div className="absolute left-[20px] bottom-[8px] text-[12px] text-white/20 font-bold " >
          ...
          <div onClick={openModal} className='absolute cursor-pointer   right-[20px] bottom-[30px] text-white press-font flex rounded-full items-center bg-purple p-2 space-x-2 '>
            <Image src={coin?.logoURI} width={20} height={20} className='' />
