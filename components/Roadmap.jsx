...
function Roadmap() {
  ...
  return (
    <section className='w-full flex items-center flex-col' >
        <h2 className="text-purple font-bold text-[30px] lg:text-[50px] lg:my-[30px] press-font ">Roadmap</h2>
                    ...
                    roadmap.map(({title, desc}, i)=>(
                        ...
                        <div className="timeline-content">
                            ...
                            <div className="content">
                                <span  className="year font-bold  press-font">{title}</span>
                                {/* <h3 className="title h4">{title}</h3> */}
                                <p className="description mt-[30px] ">
                                    {desc}
                                </p>
